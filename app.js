const TEXT_BY_LOCALE = {
  ...
  es: {
    ...
    inviteLead: "Te invitamos a:",
    weddingDate: "9.1.27",
    weddingDatePrefix: "el",
    weddingLocation: "Nuestra boda\nen Colombia",
    ...
    directionsMoreInfo: "Mas informacion pronto. Escribenos si tienes preguntas.",
    ctaComing: "Yo voy",
    ...
    mailBodyComing: "Hola,\nsi podre asistir a la boda.\n\nNombre:\nLo que deberian saber sobre mi viaje a Colombia:\n",
    mailBodyDecline: "Hola,\nno podre asistir a la boda.\n\nNombre:\n",
    mailBodyMaybe: "Hola,\naun no lo se.\n\nNombre:\n",
    topImageAlt: "Foto de nosotros en Tayrona",
  ...
  en: {
    ...
    mailBodyComing: "Hi,\nI can attend the wedding.\n\nName:\nWhat you should know about me coming to Colombia:\n",
    mailBodyDecline: "Hi,\nI cannot attend the wedding.\n\nName:\n",
    mailBodyMaybe: "Hi,\nI am not sure yet.\n\nName:\n",
    topImageAlt: "Photo of us in Tayrona",
